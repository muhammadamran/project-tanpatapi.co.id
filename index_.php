...
?>
<title>Tanpatapi Signature | Official Webiste tanpatapi.co.id</title>
...
<div id="fh5co-started" class="fh5co-section animate-box" style="background-image: url(assets/images/hero_1.jpeg);" data-stellar-background-ratio="0.5">
    <!-- <div id="fh5co-started" class="fh5co-section animate-box" style="background-image: url(assets/temp/background/02.JPG);" data-stellar-background-ratio="0.5"> -->
                ...
                <div class="col-md-6 text-center fh5co-heading">
                    <div class="d-bl">
                        ...
                        <div style="margin-right: 100px;margin-top: -30px;">
                            <font class="f-latin">Signature</font>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 text-center fh5co-heading">
