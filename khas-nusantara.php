...
?>
<title>Khas Nusantara | Official Webiste tanpatapi.co.id</title>
            ...
            <div class="signature">
                <div class="col-md-6 text-center fh5co-heading">
                    <div class="d-bl">
                        ...
                        <div style="margin-right: 28px;margin-top: -30px;">
                            <font class="f-latin">Khas Nusantara</font>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 text-center fh5co-heading">
            ...
            <div class="signature" style="margin-bottom: 40px;justify-content:space-between">
                <div class="col-md-4 fh5co-heading">
                    <div class="d-bl-menu">
                        <div class="row">
                            <div class="col-md-12">
                                <font class="f-nama-menu">NASI BOGANA</font>
                            </div>
                        </div>
                    </div>
                    <div class="d-bl">
                ...
                <div class="col-md-6 text-center fh5co-heading">
                    <div style="margin: 10px;">
                        <div style="background-color: #fff;border-radius:150px">
                            <div style="padding: 10px;">
                                <img src="assets/temp/signature/menu1.JPG" class="img-menu-s-kn" alt="Menu 1">
                            </div>
                        </div>
                    </div>
                </div>
