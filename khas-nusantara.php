                ...
                <div class="col-lg-4">
                    <div style="display: grid;">
                        ...
                        <div style="margin-top: -20px;">
                            <font class="nk-portfolio-title display-4" id="gaya">Khas Nusantara</font>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="nk-portfolio-info">
                        <div class="nk-portfolio-text">
                            <div class="graph">
                                <p>
                                    Kelezatan hidangan Nusantara tidak hanya dikagumi oleh masyarakat
                                    Indonesia, tetapi juga sampai diakui di mancanegara.
                                </p>
                                <p>
                                    Kali ini, Tanpatapi dan Chef Palitho akan mengajakmu untuk mencicipi
                                    beragam sajian khas Nusantara, karena Tanpatapi Kitchen hadir untuk
                                    merangkum semua kisah kasih yang ada di setiap perjalanan masakan
                                    Nusantara.
                                </p>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="graph" id="detail-menu">
                            <p>
                                ...
                                disajikan dengan beragam lauk, seperti Ayam Suwir
                                Bumbu Kari, Dendeng Ragi, Oseng Tempe Kacang
                                Panjang, Telur Pindang, dan Semur Tahu.
                            </p>
                        </div>
                        <div>
                        ...
                        <div class="nk-portfolio-text">
                            <div>
                                <div class="bingkai-khas">
                                    <img src="<?= $menuSignature ?>khas1.jpg" class="img-khas" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
