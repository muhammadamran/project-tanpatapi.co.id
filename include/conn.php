...
$Agakicon = $loadConfig['icon'] != NULL ? $loadConfig['icon'] : 'icon.svg';
$Agaklogo = $loadConfig['logo'] != NULL ? $loadConfig['logo'] : 'logo.png';
$URLCMS = 'http://127.0.0.1:8080/tanpatapi/tanpatapi.co.id-cms/';

$QloadContact    = $db->query("SELECT * FROM tb_contact WHERE id='1'");
$RloadContact    = mysqli_fetch_array($QloadContact);
